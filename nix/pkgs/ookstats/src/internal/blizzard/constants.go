...
func GetFallbackPeriods() []string {
	return []string{"1033", "1032", "1031", "1030", "1029", "1028", "1027", "1026", "1025", "1024", "1023", "1022", "1021", "1020"}
}

// GetGlobalPeriods returns a global sweep order newest -> oldest
func GetGlobalPeriods() []string {
	return []string{"1033", "1032", "1031", "1030", "1029", "1028", "1027", "1026", "1025", "1024", "1023"}
}
...
func GetRegionFallbackPeriods(region string) []string {
	switch region {
	case "eu":
		return []string{"1033", "1032", "1030", "1030", "1029", "1028", "1027", "1026", "1025", "1024", "1023", "1022", "1021", "1020"}
	case "us":
		return []string{"1033", "1032", "1031", "1030", "1029", "1028", "1027", "1026", "1025", "1024", "1023", "1022", "1021", "1020"}
	case "kr":
		return []string{"1033", "1032", "1031", "1030", "1029", "1028", "1027", "1026", "1025", "1024", "1023", "1022", "1021", "1020"}
